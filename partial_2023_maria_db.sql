...
CREATE DEFINER=`root`@`localhost` EVENT `config_event` ON SCHEDULE EVERY 1 MINUTE STARTS '2023-11-24 10:00:00' ENDS '2023-11-24 10:10:00' ON COMPLETION PRESERVE ENABLE DO CALL logs()$$
